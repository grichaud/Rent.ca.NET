...
public class GetPropertyDetailsTool : IAiTool
{
        ...
        string argumentsJson, ToolExecutionContext context, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            if (!doc.RootElement.TryGetProperty("property_id", out var p) ||
                p.ValueKind != JsonValueKind.String ||
                !Guid.TryParse(p.GetString(), out propertyId))
            {
