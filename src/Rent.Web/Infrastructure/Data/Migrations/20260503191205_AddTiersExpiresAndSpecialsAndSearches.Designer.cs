...
namespace Rent.Web.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260503191205_AddTiersExpiresAndSpecialsAndSearches")]
    partial class AddTiersExpiresAndSpecialsAndSearches
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rent.Web.Domain.AiConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.AiMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.Amenity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.ContactInquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.LandlordProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rent.Web.Domain.PropertyImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AmenityProperty", b =>
                {
                    b.HasOne("Rent.Web.Domain.Amenity", null)
                        .WithMany()
                        .HasForeignKey("AmenitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rent.Web.Domain.Property", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Rent.Web.Domain.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Web.Domain.AiConversation", b =>
                {
                    b.HasOne("Rent.Web.Domain.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Rent.Web.Domain.AiMessage", b =>
                {
                    b.HasOne("Rent.Web.Domain.AiConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Rent.Web.Domain.ContactInquiry", b =>
                {
                    ...
                    b.HasOne("Rent.Web.Domain.ApplicationUser", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Web.Domain.LandlordProfile", b =>
                {
                    b.HasOne("Rent.Web.Domain.ApplicationUser", "User")
                        ...
                        .HasForeignKey("Rent.Web.Domain.LandlordProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Rent.Web.Domain.Property", b =>
                {
                    b.HasOne("Rent.Web.Domain.LandlordProfile", "LandlordProfile")
                        .WithMany("Properties")
