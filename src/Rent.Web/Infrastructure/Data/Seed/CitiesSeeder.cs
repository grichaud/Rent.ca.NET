...
public static class CitiesSeeder
{
    ...
    private static City[] BuildCities()
    {
        ...
        return new[]
        {
            ...
            New("Winnipeg",       "MB", false, 49.8951,  -97.1384, Unsplash("1579454554937-235af69990bf")),
            New("Quebec City",    "QC", false, 46.8139,  -71.2080, Unsplash("1764911866769-bc27bb312c6f")),
            New("Hamilton",       "ON", false, 43.2557,  -79.8711, Unsplash("1598473801496-5b0e74340936")),
            New("Kitchener",      "ON", false, 43.4516,  -80.4925),
            New("London",         "ON", false, 42.9849,  -81.2453, Unsplash("1615288283030-0e966c5688c2")),
            New("Victoria",       "BC", false, 48.4284, -123.3656),
            New("Halifax",        "NS", false, 44.6488,  -63.5752, Unsplash("1570902128092-950ebe50a3da")),
            New("Oshawa",         "ON", false, 43.8971,  -78.8658),
            New("Windsor",        "ON", false, 42.3149,  -83.0364),
            New("Saskatoon",      "SK", false, 52.1332, -106.6700, Unsplash("1484949909760-d37c642ad869")),
