...
public static class DatabaseSeeder
{
    public static async Task RunAsync(IServiceProvider services, CancellationToken ct = default)
    {
        ...
        // otherwise MigrateAsync throws (error 40613) and — since RunAsync is awaited before
        // app.Run() — the whole process crashes and the front end returns ERR_CONNECTION_CLOSED.
